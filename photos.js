...
//locate first element where the tag is article assigne to a variable
var articleEl = document.getElementsByTagName("article")[0];
    
//create figure and img elements for firth image
...
//add appropriate src values to new img elements
...
//the rightArrow() function will be executed when the user clicks the right navigation arrow
